...
class ExploreVC: UIViewController {
    ...
    public func createAllMockData() {
        ...
        let dreamItems = [
            Category(title: "CInterpretaiton", description: "Interpreting dreams with insightful analysis",image: UIImage(named: "icon_interpretation")!, type: .Dream, prompt: "", questions: [Question(text: ""), Question(text: "")])]
        
        let nameItems = [
            Category(title: "Company Name", description: "Generate a unique name for your company.",image: UIImage(named: "icon_companyName")!, type: .Name, prompt: "", questions: [Question(text: ""), Question(text: "")]),
            Category(title: "Pet Name", description: "Generate a name for your pet.",image: UIImage(named: "icon_petName")!, type: .Name, prompt: "", questions: [Question(text: ""), Question(text: "")]),
        ...
        let entertainmentItems = [
            Category(title: "Movies to Emoji".localized(), description: "Turn movie titles into emojis".localized(), image: UIImage(named: "icon_moviestoEmoji")!, type: .Entertainment, prompt: "Be a movie-to-emoji translator. Turn movie titles into emojies. List your suggested results.",questions: [
            ...
            Category(title: "Made Up Words".localized(), description: "Create a defininition for a made up word".localized(), image: UIImage(named: "icon_madeUpWords")!, type: .Entertainment, prompt: "I want you to be an made-up words creator. Generate made up words according to the topic. Şist uour suggested results.",questions: [
        ...
        Globals.arrCategory.append(contentsOf: nameItems)
        Globals.arrCategory.append(contentsOf: dreamItems)
